const cowMaker = (cow) => {
  ...
  domString += '<button class="btn btn-danger delete-cow mx-1"><i class="far fa-trash-alt text-center"></i></button>';
  domString += '<button class="btn btn-primary edit-cow mx-1"><i class="fas fa-pencil-alt text-center"></i></button>';
